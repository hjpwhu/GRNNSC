...
public class SimplifiedLSTMLayer implements NNInterface {
	...
	// history linkId = 1. This is important!!!!! See the last line of forward
	// function.
	...
	public SimplifiedLSTMLayer(int xHiddenLength) throws Exception {
		...
		// connectInputPreOutput will link to inputLinear, forgetLinear and
	...
	public void backward() {
		for (int i = 0; i < hiddenLength; i++) {
			...
			// don't forget to add to connectInputPreOutput.inputG[1][i] at the
			// end.
		}
		...
		for (int i = 0; i < 2 * hiddenLength; i++) {
			connectInputHistory.outputG[i] = inputLinear.inputG[i] + forgetLinear.inputG[i]
