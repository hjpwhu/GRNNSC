...
public class Funcs {
	...
	public static void dumpEmbedFile(String embedFile, String encoding, HashMap<String, Integer> vocabMap,
		...
		try {
			PrintWriter writer = new PrintWriter(
					new BufferedWriter(new OutputStreamWriter(new FileOutputStream(embedFile), encoding)));
	...
	public static void filterDataWithFreq(String inPath, String encoding, int minUserFreq, int minItemFreq)
		...
		System.out.println("saved user / all user (minUserFreq = " + minUserFreq + "): " + userList.size() + "/"
				+ userCounter.size());
		System.out.println("saved item / all item (minItemFreq = " + minItemFreq + "): " + itemList.size() + "/"
				+ itemCounter.size());
		...
		System.out.println(
				"saved reviews / all reviews: " + (datasets.size() - removedIds.size()) + "/" + datasets.size());
	...
	public static void dumpCorpus(List<Data> datasets, String outpath, String encoding) throws IOException {
		PrintWriter writer = new PrintWriter(
				new BufferedWriter(new OutputStreamWriter(new FileOutputStream(outpath), encoding)));
		for (Data data : datasets) {
			writer.write(data.userStr + "\t\t" + data.productStr + "\t\t" + data.goldRating + "\t\t" + data.reviewText
					+ "\n");
		}
		writer.close();
	}
